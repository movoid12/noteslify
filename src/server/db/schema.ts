import { sqliteTable, text, primaryKey, sqliteTableCreator, index } from "drizzle-orm/sqlite-core";
...
export const createTable = sqliteTableCreator((name) => `example-app_${name}`);
  ...
  export const topics = sqliteTable("topics", {
    ...
    updatedAt: text().default(sql`(CURRENT_DATE)`).$onUpdate(() => sql`(CURRENT_DATE)`),
